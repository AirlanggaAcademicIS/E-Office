...
<style> h1 {font-size: 30px;}</style> <h1>Forward to</h1>
	 ...
	 <tr>
      ...
      <td width="117"><label>
        <select name="select2" onChange="this.form.submit()">
          <option value="None"<?php if(isset($_POST['select2'])){if($_POST['select2']=="None") echo " selected='selected'";}?>>None</option>
		   <option value="ALL"<?php if(isset($_POST['select2'])){if($_POST['select2']=="ALL") echo " selected='selected'";}?>>ALL</option>
          <option value="laki-laki"<?php if(isset($_POST['select2'])){if($_POST['select2']=="laki-laki")echo " selected='selected'";}?>>Laki-Laki</option>
		  <option value="perempuan"<?php if(isset($_POST['select2'])){if($_POST['select2']=="perempuan")echo " selected='selected'";}?>>Perempuan</option>
        </select>
      </label></td>
    </tr>
  ...
  <p>Nama Dosen :</p>
	...
	{
	// jika none maka  select * from signup
    ...
    <label><input type='checkbox' value='".$data['nama_karyawan']."'> ".$data['nama_karyawan']." </label></div>";
		...
		$sql="select * from signup where jenis_kelamin=  '".$_POST['select2']."'";
		$hasil=mysql_query($sql);
	...
	?>
                         ...
                         <button type="button" class="btn btn-primary" data-toggle="collapse" data-parent="#accordion">SEND</button>
