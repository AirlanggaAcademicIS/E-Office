	...
	<div class="container body">
		<div class="main_container">
			...
			<div class="right_col" role="main">
				...
				<div class="row">
                    <div class="center">KOTAK SURAT</div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">

							
								<div class="col-md-6">
									<a href="kotakMasuk.php"><h3>KOTAK MASUK</h3></a>
								</div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <ul>
                                     <hr>
                                    <li><a href="">kotak masuk surat 1</a></li>
                                     <hr>
                                    <li><a href="">kotak masuk surat 2</a></li>
                                     <hr>
                                    <li><a href="">kotak masuk surat 3</a></li>
                                     <hr>
                                    <li><a href="">kotak masuk surat 4</a></li>
                                     <hr>
                                </ul>
                                <div ><a href="kotakMasuk.php">Surat Lainnya </a>
                                </div>
							</div>
								...
								<div class="row x_title">
								    ...
								    <div class="col-md-6">
									<a href="kotakKeluar.php"><h3>KOTAK KELUAR</h3></a>
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
								<ul>
                                    <hr>
                                    <li><a href="">kotak keluar surat 1</a></li>
                                    <hr>
                                    <li><a href="">kotak keluar surat 2</a></li>
                                     <hr>
                                    <li><a href="">kotak keluar surat 3</a></li>
                                     <hr>
                                    <li><a href="">kotak keluar surat 4</a></li>
                                     <hr>
                                </ul>
                              <div ><a href="kotakKeluar.php">Surat Lainnya </a>
                                </div>
							</div>
