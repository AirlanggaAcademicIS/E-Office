...
<head>
    ...
    <!--PERSIAPAN PHP-->
    <!-- menghitung jumlah pesan yang belum terbaca -->
    <?php
    ...
    <?php
    $Pengguna=$_GET['pengguna'];
    $query="Select Pengirim,Judul_Pesan,Tanggal_kirim,Status_penerima from pesan where Penerima ='".$Pengguna."' ORDER BY Tanggal_kirim DESC";//Query select list Kotak Pesan
        $hasil=mysql_query ($query);
        if($hasil==false){
        echo "salah";
        }else{
				...
				<div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
								<!--MENGISI KOTAK SURAT dari DATABASE -->
                                    ...
                                    <tbody>
                                      ...
                                      <?php while ($data = mysql_fetch_array ($hasil)){
                                        ...
                                        <? if($statusPenerima==0){?><tr bgcolor=#dfbe9f><?}
                                        else{?><tr><?}?>    
