			...
			<div class="right_col" role="main">
				...
				<div class="row">
						...
						<div class="dashboard_graph">
                            ...
                            <div class="row">
                                <div class="col-md-1">
                                    <img src="images/user.png" class="img-rounded" alt="nama pengguna" width=100px height=100px>
                                </div>
                                <div class="col-md-11">
                                <h2><strong>JUDUL SURAT <small> (tanggal surat)</small></strong></h2>
                                <h2><strong>NAMA PENGIRIM</strong></h2>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                            ...
                            <div class="row">
                            <button data-toggle="collapse" data-target="#demo">Track Surat</button>
