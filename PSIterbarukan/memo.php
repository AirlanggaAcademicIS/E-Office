                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 ">
                        <select class="form-control" name="keterangan">
                          ...
                          <option>Mohon Saran</option>
                          <option>Untuk Perhatian</option>
                          <option>Siapkan Konsep</option>
                          <option>Siapkan Laporan</option>
                          <option>Untuk Diproses</option>
                          <option>Selesaikan Segera</option>
                          <option>Arsip</option>
...
<?php 
    ...
    mysql_query($input);
                                       //memulai proses membalas, identifikasi penerima pengirim dan isi pesan=keteranganBalas
                                        ...
                                        $Pengirim=$Pengguna;
                                        $JudulPesan=$kode;
                                        $Keterangan= $agenda."<br>".$tanggal."<br>".$kode."<br>".$diteruskan."<br>".$sifat."<br>"
                                                        .$isi. "<br>".$keterangan. "<br>".$nomer. "<br>";
        echo $Keterangan;
                                        $adminTU=array();$i=0;
                                        $namafile="tidak ada";
            $query="select Nama_Pegawai from Pegawai where Jabatan = 'TU'";
                                       $hasil= mysql_query($query);
            while ($data= mysql_fetch_array($hasil)){
                $adminTU[$i]=$data[0];$i++;}
    ...
    for($j=0;$j<$i;$j++){
                                                  ...
                                                  $query ="INSERT INTO pesan (No_Pesan,Judul_Pesan,Tanggal,Waktu,Keterangan,File,Pengirim,Penerima,Tanggal_kirim,Status_pengirim,Status_penerima) VALUES ('null','$JudulPesan','null','null','$Keterangan','$namafile','$Pengguna','$Penerima','$TanggalSekarang','0','0')";
                                             mysql_query ($query);
        echo "BERHASIL"; 
    }}
